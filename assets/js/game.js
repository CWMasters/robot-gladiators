...
//funtcion to generate a random numeric value
...
// function to see if player want's to fight or skip
var fightOrSkip = function () {
    ...
    if (confirmSkip) {
      ...
      // stop while () loops using break; and enter next fight
...
var fight = function(enemy) {
    ...
    while (playerInfo.health > 0 && enemy.health > 0) {
      ...
      // switcch turn order for next round
...
//play again  
    ...
    var endGame = function() {
       ...
       //check locaStorage for high score, if it's not there, use 0
...
// use shop fucntion between battles
var shop = function() {
